...
<div class="menu-container">
    <div class="menu-item">
        <img src="https://via.placeholder.com/200x150?text=Beef+BBQ" alt="Beef BBQ">
        <h4>Beef BBQ</h4>
        <p>Rp 45.000</p>
    ...
    <div class="menu-item">
        <img src="https://via.placeholder.com/200x150?text=Chicken+Sukiyaki" alt="Chicken Sukiyaki">
    ...
    <div class="menu-item">
        <img src="https://via.placeholder.com/200x150?text=Matcha+Ice+Cream" alt="Matcha Ice Cream">
